# pixel_mapper
A small collection of Python scripts for semi-automatic mapping of RGB pixels in 3D space using computer vision.  Designed particularly for wrapping trees with pixels.
